...
export default function KeeperMapView() {
    ...
    const [selectHiveButton, setSelectHiveButton] = useState(true);
    const [placeHiveButton, setPlaceHiveButton] = useState(false);
    const mapRef = useRef();
    ...
    const handleOnButtonPress = () => {
        console.log(placeHiveButton, selectHiveButton);
        setSelectHiveButton(!selectHiveButton);
        setPlaceHiveButton(!placeHiveButton);
    }
    ...
    return (
        <View style={Styles.container}>
            ...
            <View style={Styles.optionGroup}>
                <Button disabled={placeHiveButton}
                        title={"Place Hive"}
                        onPress={handleOnButtonPress}/>
                <Button disabled={selectHiveButton}
                        title={"Select Hive"}
                        onPress={handleOnButtonPress}/>
            </View>
